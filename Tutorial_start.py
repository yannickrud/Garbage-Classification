...
with st.expander("CRISP-DM-Model"):
    ...
    "The Cross industry standard process for data mining (CRISP-DM process model) provides a guide to help you develop an ordered approach towards building, understanding," \
